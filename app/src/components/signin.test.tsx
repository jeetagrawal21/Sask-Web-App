...
//   it('should have a "REQUEST ACCOUNT" button', () => {
//     render(<SignIn />);
//     const requestAccountButton = screen.getByText("REQUEST ACCOUNT");
...
//   it('should display a loading indicator when "SIGN IN" button is clicked', () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "user@example.com" } });
...
//   it("should navigate to the dashboard page when authentication is successful", async () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "user@example.com" } });
...
//     const dashboardPage = await screen.findByText("Dashboard");
...
//     const requestAccountPage = screen.getByText("Request Account");
//     expect(requestAccountPage).toBeInTheDocument();
//   });

//   it("should authenticate the user when valid email and password are provided", () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "user@example.com" } });
...
//   it("should not authenticate the user when invalid email and password are provided", () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "invalid_email" } });
...
//   it("should not authenticate the user when email field is empty", () => {
//     render(<SignIn />);
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(passwordInput, { target: { value: "password123" } });
//     const signInButton = screen.getByText("SIGN IN");
...
//   it("should not authenticate the user when email field contains only spaces", () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
...
//   it("should not authenticate the user when password field contains only spaces", () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "user@example.com" } });
...
//   it("should not authenticate the user when email and password fields are empty", () => {
//     render(<SignIn />);
//     const signInButton = screen.getByText("SIGN IN");
//     fireEvent.click(signInButton);
...
//   it("should not authenticate the user when email and password fields contain only spaces", () => {
//     render(<SignIn />);
//     const emailInput = screen.getByPlaceholderText("Email");
//     const passwordInput = screen.getByPlaceholderText("Password");
//     fireEvent.change(emailInput, { target: { value: "   " } });
...
//   it('should redirect to ForgotPassword component when "FORGOT PASSWORD" button is clicked', () => {
//     render(<SignIn />);
